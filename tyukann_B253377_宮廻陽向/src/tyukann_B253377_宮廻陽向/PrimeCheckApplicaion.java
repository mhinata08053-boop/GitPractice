...
public class PrimeCheckApplicaion {
	
	public static boolean evencheckPrime(int n) {				//方法①偶数スキップ
	...
	public static boolean squarecheckPrime(int n) {				//方法②√1000000までを計算
	...
	public static boolean evensquarecheckPrime(int n) {			//方法③偶数スキップ＋√1000000までを計算
